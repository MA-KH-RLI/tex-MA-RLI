...
In \autoref{tab:grid_IDs} werden die untersuchten \gls{MS}-Netze nach ihrem \gls{ID} kategorisiert und die Anzahl an repräsentierten Netzgebiete dargestellt.
