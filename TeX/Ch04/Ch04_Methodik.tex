...
Die Synthetisierung der Netztopologien ist nicht Teil dieser Arbeit und erfolgte innerhalb des \gls{OPENEGO} Projektes \cite{Mueller2019}.
...
Da hierdurch unter Umständen nur wenige Anschlusspunkte generiert werden, werden ergänzend \SI{50}{\percent} der möglichen öffentlichen Normalladeinfrastruktur zusätzlich für Ladeinfrastruktur auf \Firmeparkplaetzen genutzt.
