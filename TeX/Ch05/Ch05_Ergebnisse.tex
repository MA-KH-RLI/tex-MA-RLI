...
\input{Ch05/fig/Ch05_fig_01_grid_176_map}
...
Insgesamt wurden somit sechs Netzgebiete untersucht, die stellvertretend für \num{1842} der \num{3591} Mittelspannungsnetze stehen.
...
\input{Ch05/fig/Ch05_fig_02_bar_representatives}

\input{Ch05/fig/Ch05_fig_03_map_representatives}
...
\input{Ch05/tab/Ch05_tab_02_car_count}
...
\input{Ch05/tab/Ch05_tab_03_bev_distance}
...
Im Mittel liegt der Anteil flexibilisierer Ladevorgänge über alle Szenarien je Gemeinde bei \SI{75.2}{\percent}.
...
Der Anteil flexibilisierer Ladevorgänge liegt bei dieser Szenarette bei \SI{70.0}{\percent}.
In \autoref{tab:ChargingShare} findet sich die entsprechende Aufteilung.

\input{Ch05/tab/Ch05_tab_04_ChargingShare}
...
Zusätzlich findet sich das \gls{EPKW}-Lastprofil der gleichen Gemeinde in der \SzeFirmenparkplatz (rechts).

\input{Ch05/fig/Ch05_fig_04_example_load_profile}

Die Lastgänge \zH und \Firmeparkplatz entsprechen den flexibilisierbaren Ladevorgängen im privaten Bereich.
...
Gegenüber dem Antriebswende-Szenario sinkt die Höchstlast in der \SzeFirmenparkplatzdot, jedoch sinkt auch das Flexibilisierungspotential bei gleichbleibendem Energiebedarf durch die Verschiebung der Ladevorgänge in den öffentlichen Raum.

\input{Ch05/fig/Ch05_fig_05_example_load_curve}
