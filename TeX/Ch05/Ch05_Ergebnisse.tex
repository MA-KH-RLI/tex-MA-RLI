...
\input{Ch05/tab/Ch05_tab_04_standing_times}
...
\input{Ch05/tab/Ch05_tab_05_ChargingShare}
...
\input{Ch05/fig/Ch05_fig_06_cps_dist}


\subsection{Ergebnisse der Implementierung der Ladestrategien}\label{chap:results_charging_strategies}

Im Rahmen der Netzuntersuchungen innerhalb dieser Arbeit kommt den Zeitreihen der Last der \glspl{EPKW} die größte Bedeutung zu, da die Last und Erzeugung aller anderen Verbraucher und Erzeuger nicht veränderlich ist.
Das Ziel der Ladestrategien (s. \autoref{chap:theo_strategies} ist es, die Netzbelastung möglichst gering zu halten.
Bei dem gruppierten und reduzierten Laden soll dies durch ein präventives Lademanagement und bei dem Residuallast-Laden durch ein kuratives Lademanagement erreicht werden.
