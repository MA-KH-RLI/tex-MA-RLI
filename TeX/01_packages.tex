...
\def\dingo{\texttt{ding0}~}
\def\dingodot{\texttt{ding0}}
\def\edisgo{\texttt{eDisGo}~}
\def\edisgodot{\texttt{eDisGo}}
\def\ego{\texttt{eGo~100}~}
\def\egodot{\texttt{eGo~100}}
...
\def\kmeans{\texttt{k-means-Clusterings}~}
\def\kmeansdot{\texttt{k-means-Clusterings}}
\def\localiserTool{\texttt{Localiser~Tool}~}
\def\localiserTools{\texttt{Localiser~Tools}~}
\def\localiserToolsKomma{\texttt{Localiser~Tools}}
\def\nH{\glqq nach Hause\grqq{}~}
\def\nHdot{\glqq nach Hause\grqq}
\def\oeffen{\glqq Öffentlich\grqq{}~}
\def\oeffendot{\glqq Öffentlich\grqq}
\def\openego{\texttt{open\_eGo}~}
\def\openegodot{\texttt{open\_eGo}}
\def\Plus{\texttt{+}}
\def\Regiostar{\texttt{RegioStaR~7}~}
\def\Regiostardot{\texttt{RegioStaR~7}}
\def\simbev{\texttt{simBEV}~}
\def\Straszenrand{\glqq Straßenrand\grqq{}~}
\def\Straszenranddot{\glqq Straßenrand\grqq}
\def\SzeFirmenparkplatz{Szenarette \glqq Firmenparkplatz\grqq{}~}
\def\SzeFirmenparkplatzdot{Szenarette \glqq Firmenparkplatz\grqq}
