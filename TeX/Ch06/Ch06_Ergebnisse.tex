...
elung: \section{Ergebnisse und Diskussion}\label{chap:results}
...
Der lastseitige Abregelungsbedarf beschränkt sich hierbei beinahe vollständig auf die \gls{NS}-Ebene, da die \gls{MS}-Ebene aufgrund des höheren Anteils von \gls{FEE} Anlagen mit einem direkten Anschluss in der \gls{MS}-Ebene bereits auf hohe Lasten ausgelegt ist.
...
% lastseitige Abregelung: es wird sich vermehrt nach einer globalen Residuallast gerichtet die stark von dem lokalen Zustand der NS Netze zu tun hat
