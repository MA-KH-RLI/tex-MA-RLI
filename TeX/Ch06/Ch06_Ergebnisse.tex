...
{\color{red} TODO: Tabelle Woche A und B}
...
\input{Ch06/tab/Ch06_tab_07_pv_dominated_week_A_char}
...
\input{Ch06/tab/Ch06_tab_08_pv_dominated_week_A_load_cur}
...
\input{Ch06/tab/Ch06_tab_09_pv_dominated_week_A_fee_cur}

\autoref{fig:176_1056_cur_fee_grid_week_A}
...
%
%\input{Ch06/tab/Ch06_tab_08_pv_dominated_week_A_fee}
%
...
%{\color{red} TODO: 176}
%
%\input{Ch06/fig/Ch06_fig_06_1056_diff_cur}
%
...
%So kann im Antriebswende-Szenario und der \SzeFirmenparkplatz sowohl durch das reduzierte Laden als auch das Residuallast-Laden eine Reduktion des Abregelungsbedarfs erreicht werden, wobei das Residuallast-Laden in der Regel leichte Vorteile aufweist.
...
%In den beiden anderen Szenarien mit geringeren Hochlaufzahlen lassen sich keine nennenswerten Vorteile durch die Ladestrategien erkennen.
